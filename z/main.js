...
, function(e, t, n) {
    (function(t) {
        var n = function(e) {
            var t = /\blang(?:uage)?-([\w-]+)\b/i
              ...
              , r = {
                    ...
                    DFS: function e(t, n, o, a) {
                        ...
                        for (var l in t)
                            if (t.hasOwnProperty(l)) {
                                ...
                                var u = t[l]
                                  , s = r.util.type(u);
                                "Object" !== s || a[i(u)] ? "Array" !== s || a[i(u)] || (a[i(u)] = !0,
                                e(u, n, l, a)) : (a[i(u)] = !0,
                                e(u, n, null, a))
                            }
                    }
                ...
                highlightAllUnder: function(e, t, n) {
                    ...
                    for (var a, i = e.querySelectorAll(o.selector), l = 0; a = i[l++]; )
                        r.highlightElement(a, !0 === t, o.callback)
                },
                highlightElement: function(n, o, a) {
                    for (var i, l = "none", u = n; u && !t.test(u.className); )
                        u = u.parentNode;
                    u && (l = (u.className.match(t) || [, "none"])[1].toLowerCase(),
                    i = r.languages[l]),
                    n.className = n.className.replace(t, "").replace(/\s+/g, " ") + " language-" + l,
                    n.parentNode && (u = n.parentNode,
                    /pre/i.test(u.nodeName) && (u.className = u.className.replace(t, "").replace(/\s+/g, " ") + " language-" + l));
                    var s = {
                        element: n,
                        language: l,
                        grammar: i,
                    ...
                    if (r.hooks.run("before-sanity-check", s),
                    s.code)
                        if (r.hooks.run("before-highlight", s),
                        s.grammar)
                            if (o && e.Worker) {
                                ...
                                c(r.highlight(s.code, s.grammar, s.language));
                        else
                            c(r.util.encode(s.code));
                    else
                        r.hooks.run("complete", s)
                },
                    ...
                    for (var s in n)
                        if (n.hasOwnProperty(s) && n[s]) {
                            ...
                            for (var p = 0; p < c.length; ++p) {
                                ...
                                f = f.pattern || f;
                                for (var b = a, k = i; b < t.length; k += t[b].length,
                                ++b) {
                                    var w = t[b];
                                    ...
                                    if (!(w instanceof o)) {
                                        if (g && b != t.length - 1) {
                                            ...
                                            !(S = f.exec(e)))
                                                break;
                                            for (var C = S.index + (h ? S[1].length : 0), E = S.index + S[0].length, x = b, P = k, T = t.length; x < T && (P < E || !t[x].type && !t[x - 1].greedy); ++x)
                                                C >= (P += t[x].length) && (++b,
                                                k = P);
                                            if (t[b]instanceof o)
                                                continue;
                ...
                tokenize: function(e, t) {
                    ...
                    return r.matchGrammar(e, n, t, 0, 0, !1),
                    n
                },
                hooks: {
                    all: {},
            ...
            return a && (r.filename = a.src,
            r.manual || a.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(r.highlightAll) : window.setTimeout(r.highlightAll, 16) : document.addEventListener("DOMContentLoaded", r.highlightAll))),
            r
            ...
            Array.prototype.slice.call(e.querySelectorAll("pre[data-src]")).forEach(function(e) {
                if (!e.hasAttribute("data-src-loaded")) {
                    ...
                    s.onreadystatechange = function() {
                        4 == s.readyState && (s.status < 400 && s.responseText ? (u.textContent = s.responseText,
                        n.highlightElement(u),
                        e.setAttribute("data-src-loaded", "")) : s.status >= 400 ? u.textContent = "✖ Error " + s.status + " while fetching file: " + s.statusText : u.textContent = "✖ Error: File does not exist or is empty")
                    }
                    ,
                    s.send(null)
                }
...
, function(e, t, n) {
    ...
    b.cloneElement = function(e, t, n) {
        ...
        if (null != t) {
            ...
            for (s in t)
                m.call(t, s) && !v.hasOwnProperty(s) && (o[s] = void 0 === t[s] && void 0 !== u ? u[s] : t[s])
        }
    ...
    function T(e, t, n, r) {
        ...
        null === e || "string" === o || "number" === o || "object" === o && e.$$typeof === w)
            return n(r, e, "" === t ? "." + S(e, 0) : t),
            1;
        var a = 0;
        if (t = "" === t ? "." : t + ":",
        Array.isArray(e))
            ...
            "object" === o && i("31", "[object Object]" === (n = "" + e) ? "object with keys {" + Object.keys(e).join(", ") + "}" : n, "");
        return a
    }
    function S(e, t) {
    ...
    function N(e, t, n) {
        ...
        Array.isArray(e) ? A(e, r, n, a.thatReturnsArgument) : null != e && (b.isValidElement(e) && (e = b.cloneAndReplaceKey(e, o + (!e.key || t && t.key === e.key ? "" : ("" + e.key).replace(C, "$&/") + "/") + n)),
        r.push(e))
    }
    ...
    e.exports = {
        Children: {
            ...
            toArray: F.toArray,
            only: function(e) {
                return b.isValidElement(e) || i("143"),
                e
            }
        },
...
, function(e, t, n) {
                ...
                !C.plugins[n])
                    ...
                    n = t.eventTypes) {
                        ...
                        if (u) {
                            ...
                            a.registrationName ? (w(a.registrationName, i, l),
                            o = !0) : o = !1;
                        o || d("98", r, e)
                    }
            }
        ...
        injectEventPluginsByName: function(e) {
            ...
            for (t in e)
                if (e.hasOwnProperty(t)) {
                    var r = e[t];
                    b.hasOwnProperty(t) && b[t] === r || (b[t] && d("102", t),
                    b[t] = r,
                    n = !0)
                }
            n && k()
    ...
    var T = {
        ...
        injectDOMPropertyConfig: function(e) {
            ...
            for (var a in e = e.DOMMutationMethods || {},
            n) {
      ...
      , S = {
        ...
        shouldSetAttribute: function(e, t) {
            if (S.isReservedProp(e) || !("o" !== e[0] && "O" !== e[0] || "n" !== e[1] && "N" !== e[1]))
                return !1;
            if (null === t)
                return !0;
            switch (typeof t) {
    ...
    function xe(e) {
        ...
        if (e.alternate)
            ...
            if ((t.effectTag & Ee) !== Ce)
                return 1;
            for (; t.return; )
                if (((t = t.return).effectTag & Ee) !== Ce)
                    return 1
        }
        return t.tag === be ? 2 : 3
    }
    ...
    var Se = function(e) {
      ...
      , Fe = {
        ...
        invokeGuardedCallbackAndCatchFirstError: function(e, t, n, r, o, a, i, l, u) {
            if (Fe.invokeGuardedCallback.apply(this, arguments),
            Fe.hasCaughtError()) {
                var s = Fe.clearCaughtError();
                Fe._hasRethrowError || (Fe._hasRethrowError = !0,
                Fe._rethrowError = s)
            }
        },
    ...
    function Xe(e) {
        ...
        do {
            ...
            if (!n)
                break;
            e.ancestors.push(t),
            t = oe.getClosestInstanceFromNode(n)
        } while (t);
        for (n = 0; n < e.ancestors.length; n++)
            t = e.ancestors[n],
            Je._handleTopLevel(e.topLevelType, t, e.nativeEvent, Ge(e.nativeEvent))
    }
    var Je = {
        _enabled: !0,
        ...
        dispatchEvent: function(e, t) {
            if (Je._enabled) {
                var n = Ge(t);
                if (null === (n = oe.getClosestInstanceFromNode(n)) || "number" != typeof n.tag || Se(n) || (n = null),
                Ze.length) {
                    var r = Ze.pop();
                    r.topLevelType = e,
                    r.nativeEvent = t,
    ...
    var rt = null;
    function ot(e, t) {
        e && (Me.executeDispatchesInOrder(e, t),
    ...
    var ut, st = {
        ...
        getListener: function(e, t) {
            if ("number" == typeof e.tag) {
                ...
                if ("string" == typeof (r = e._currentElement) || "number" == typeof r || !e._rootNodeID)
                    return null;
                if (n = (e = r.props)[t],
                lt(t, r.type, e))
                    return null
            }
            return n && "function" != typeof n && d("231", t, typeof n),
            n
        },
    ...
    function ct(e, t) {
        ...
        !n && ut && "wheel" === e && (n = document.implementation.hasFeature("Events.wheel", "3.0")),
        n
    }
    function pt(e, t) {
        var n = {};
    ...
    function gt(e) {
        ...
        var t, n = ft[e];
        for (t in n)
            if (n.hasOwnProperty(t) && t in ht)
                return dt[e] = n[t];
        return ""
    }
    o.canUseDOM && (ht = document.createElement("div").style,
    ...
    function kt(e) {
        return Object.prototype.hasOwnProperty.call(e, bt) || (e[bt] = vt++,
        yt[e[bt]] = {}),
        yt[e[bt]]
    }
    var wt = a({}, {
        ...
        listenTo: function(e, t) {
            ...
            for (var r = 0; r < e.length; r++) {
                var o = e[r];
                n.hasOwnProperty(o) && n[o] || ("topWheel" === o ? ct("wheel") ? et.trapBubbledEvent("topWheel", "wheel", t) : ct("mousewheel") ? et.trapBubbledEvent("topWheel", "mousewheel", t) : et.trapBubbledEvent("topWheel", "DOMMouseScroll", t) : "topScroll" === o ? et.trapCapturedEvent("topScroll", "scroll", t) : "topFocus" === o || "topBlur" === o ? (et.trapCapturedEvent("topFocus", "focus", t),
                et.trapCapturedEvent("topBlur", "blur", t),
                n.topBlur = !0,
                n.topFocus = !0) : "topCancel" === o ? (ct("cancel", !0) && et.trapCapturedEvent("topCancel", "cancel", t),
                n.topCancel = !0) : "topClose" === o ? (ct("close", !0) && et.trapCapturedEvent("topClose", "close", t),
                n.topClose = !0) : mt.hasOwnProperty(o) && et.trapBubbledEvent(o, mt[o], t),
                n[o] = !0)
            }
        },
        ...
        t)
            if (t.hasOwnProperty(n)) {
                var r = 0 === n.indexOf("--")
                  , o = n
                  , a = t[n];
                if (o = null == a || "boolean" == typeof a || "" === a ? "" : r || "number" != typeof a || 0 === a || Pt.hasOwnProperty(o) && Pt[o] ? ("" + a).trim() : a + "px",
                "float" === n && (n = "cssFloat"),
                r)
                    e.setProperty(n, o);
                else if (o)
    ...
    var Ot = {
        ...
        setValueForProperty: function(e, t, n) {
            ...
            if (r && _.shouldSetAttribute(t, n)) {
                ...
                o ? o(e, n) : null == n || r.hasBooleanValue && !n || r.hasNumericValue && isNaN(n) || r.hasPositiveNumericValue && 1 > n || r.hasOverloadedBooleanValue && !1 === n ? Ot.deleteValueForProperty(e, t) : r.mustUseProperty ? e[r.propertyName] = n : (t = r.attributeName,
                ...
                Ot.setValueForAttribute(e, t, _.shouldSetAttribute(t, n) ? n : null)
        },
        setValueForAttribute: function(e, t, n) {
            (function(e) {
                return !!Ft.hasOwnProperty(e) || !At.hasOwnProperty(e) && (Nt.test(e) ? Ft[e] = !0 : (At[e] = !0,
                !1))
            }
    ...
    function Xt(e, t) {
        t && (Zt[e] && (null != t.children || null != t.dangerouslySetInnerHTML) && d("137", e, ""),
    ...
    var en = {
        ...
        updateValueIfChanged: function(e) {
            ...
            var n = t.getValue()
              , r = "";
            return e && (r = Jt(e) ? e.checked ? "true" : "false" : e.value),
            (e = r) !== n && (t.setValue(e),
            !0)
        },
    ...
    var nn, rn, on = g, an = (rn = function(e, t) {
        if (e.namespaceURI !== on.svg || "innerHTML"in e)
            ...
            for ((nn = nn || document.createElement("div")).innerHTML = "<svg>" + t + "</svg>",
            t = nn.firstChild; t.firstChild; )
    ...
    var cn = sn
      , pn = (Mt.getCurrentFiberOwnerName,
    W)
      , fn = z
      , dn = wt.listenTo
    ...
    var vn = {
      ...
      , bn = {
        createElement: function(e, t, n, r) {
            return n = n.nodeType === pn ? n : n.ownerDocument,
            r === gn && (r = mn(e)),
            r === gn ? "script" === e ? ((e = n.createElement("div")).innerHTML = "<script><\/script>",
        ...
        setInitialProperties: function(e, t, n, r) {
            ...
            case "input":
                en.track(e),
                jt.postMountWrapper(e, n);
                break;
            case "textarea":
                en.track(e),
                Qt.postMountWrapper(e, n);
                break;
            case "option":
                Bt(e, n);
                break;
            ...
            n)
                if (!r.hasOwnProperty(a) && n.hasOwnProperty(a) && null != n[a])
                    if ("style" === a)
                        ...
                        "dangerouslySetInnerHTML" !== a && "children" !== a && "suppressContentEditableWarning" !== a && (hn.hasOwnProperty(a) ? u || (u = []) : (u = u || []).push(a, null));
            for (a in r) {
                var s = r[a];
                ...
                r.hasOwnProperty(a) && s !== t && (null != s || null != t))
                    if ("style" === a)
                        if (t) {
                            for (i in t)
                                !t.hasOwnProperty(i) || s && s.hasOwnProperty(i) || (e || (e = {}),
                                e[i] = "");
                            for (i in s)
                                s.hasOwnProperty(i) && t[i] !== s[i] && (e || (e = {}),
                                e[i] = s[i])
                        } else
                            e || (u || (u = []),
                            u.push(a, e)),
                        ...
                        t = t ? t.__html : void 0,
                        null != s && t !== s && (u = u || []).push(a, "" + s)) : "children" === a ? t === s || "string" != typeof s && "number" != typeof s || (u = u || []).push(a, "" + s) : "suppressContentEditableWarning" !== a && (hn.hasOwnProperty(a) ? (null != s && yn(o, a),
                        u || t === s || (u = [])) : (u = u || []).push(a, s))
            }
            return e && (u = u || []).push("style", e),
            u
        },
        updateProperties: function(e, t, n, r, o) {
            ...
            switch (n) {
            case "input":
                jt.updateWrapper(e, o),
                en.updateValueIfChanged(e);
                break;
            case "textarea":
        ...
        diffHydratedProperties: function(e, t, n, r, o) {
            ...
            n)
                ...
                "children" === i ? "string" == typeof a ? e.textContent !== a && (r = ["children", a]) : "number" == typeof a && e.textContent !== "" + a && (r = ["children", "" + a]) : hn.hasOwnProperty(i) && null != a && yn(o, i));
            switch (t) {
            case "input":
                en.track(e),
                jt.postMountWrapper(e, n);
    ...
    if (o.canUseDOM)
        if ("function" != typeof requestIdleCallback) {
            ...
            window.addEventListener("message", function(e) {
                e.source === window && e.data === Nn && (En = !1,
                e = Cn,
                Cn = null,
                null !== e && e(_n))
            }, !1);
    ...
    function Gn(e, t) {
        t = t.priorityLevel;
        var n = null;
        if (null !== e.last && 0 >= qn(e.last.priorityLevel, t))
            n = e.last;
        else
    ...
    function Qn(e, t) {
        ...
        return null === n ? (Yn(o, t, a, i),
        null) : (e = null !== (r = Gn(n, t)) ? r.next : n.first,
        Yn(o, t, a, i),
        i === e && null !== i || a === r && null !== a ? (null === r && (n.first = t),
        null === e && (n.last = null),
        null) : (Yn(n, t = {
    ...
    var Xn = function(e, t, n, r) {
      ...
      , nr = function(e, t, n, r) {
        ...
        o && (n = Kn,
        null !== (o = $n) && null !== t.next && (t.next = null,
        o.last = t),
      ...
      , rr = function(e, t, n, r, o, i, l) {
        ...
        for (var u = n.hasForceUpdate, s = !0, c = n.first; null !== c && 0 >= qn(c.priorityLevel, l); ) {
            ...
            c.isReplace ? (o = Zn(c, r, o, i),
            s = !0) : (p = Zn(c, r, o, i)) && (o = s ? a({}, o, p) : a(o, p),
            s = !1),
            c.isForced && (u = !0),
            null === c.callback || c.isTopLevelUnmount && null !== c.next || ((e = null !== e ? e : []).push(c.callback),
            t.effectTag |= jn),
            c = c.next
        }
    ...
    var Er = function(e) {
      ...
      , Ir = function(e) {
        if (!wr(e))
            return !1;
        var t = e.stateNode;
        return t = t && t.__reactInternalMemoizedMergedChildContext || u,
        br = yr.current,
        mr(yr, t, e),
        mr(vr, vr.current, e),
        !0
    ...
    function Zr(e, t, n) {
        var r = void 0;
        return "function" == typeof e ? (r = e.prototype && e.prototype.isReactComponent ? new Qr(jr,t,n) : new Qr(Ur,t,n)).type = e : "string" == typeof e ? (r = new Qr(Br,t,n)).type = e : "object" == typeof e && null !== e && "number" == typeof e.tag ? r = e : d("130", null == e ? e : typeof e, ""),
        r
    }
    var Xr, Jr, eo = function(e, t) {
        var n = e.alternate;
        return null === n ? ((n = new Qr(e.tag,e.key,e.internalContextTag)).type = e.type,
        n.stateNode = e.stateNode,
        n.alternate = e,
        e.alternate = n) : (n.effectTag = Gr,
        n.nextEffect = null,
        n.firstEffect = null,
        n.lastEffect = null),
        ...
        return (t = Zr(e.type, e.key, t)).pendingProps = e.props,
        t.pendingWorkPriority = n,
        t
    }, no = function(e, t, n) {
        return (t = new Qr(Kr,null,t)).pendingProps = e,
        t.pendingWorkPriority = n,
        t
    }, ro = function(e, t, n) {
        return (t = new Qr(Vr,null,t)).pendingProps = e,
        t.pendingWorkPriority = n,
        t
    }, oo = function() {
        ...
        return (t = new Qr(zr,e.key,t)).type = e.handler,
        t.pendingProps = e,
        t.pendingWorkPriority = n,
        t
    }, io = function(e, t) {
        ...
        return (t = new Qr(Wr,e.key,t)).pendingProps = e.children || [],
        t.pendingWorkPriority = n,
        t.stateNode = {
    ...
    "function" == typeof Symbol && Symbol.for ? (Xr = Symbol.for("react.coroutine"),
    Jr = Symbol.for("react.yield")) : (Xr = 60104,
    Jr = 60105);
    var go = {
    ...
    function Vo(e, t) {
        ...
        if (null !== n && "function" != typeof n) {
            if (t._owner) {
                var r = void 0;
                (t = t._owner) && ("number" == typeof t.tag ? (t.tag !== Ao && d("110"),
                r = t.stateNode) : r = t.getPublicInstance()),
                r || d("147", n);
                var o = "" + n;
    ...
    function zo(e, t) {
        ...
        function i(e, n, r) {
            return e.index = r,
            t ? null !== (r = e.alternate) ? (r = r.index) < n ? (e.effectTag = Mo,
            n) : r : (e.effectTag = Mo,
            n) : n
        }
        function l(e) {
            return t && null === e.alternate && (e.effectTag = Mo),
            e
        }
        function u(e, t, n, r) {
            return null === t || t.tag !== Fo ? ((n = xo(n, e.internalContextTag, r)).return = e,
            n) : ((t = a(t, r)).pendingProps = n,
            t.return = e,
            t)
        }
        function s(e, t, n, r) {
            return null === t || t.type !== n.type ? ((r = Co(n, e.internalContextTag, r)).ref = Vo(t, n),
            r.return = e,
            r) : ((r = a(t, r)).ref = Vo(t, n),
            r.pendingProps = n.props,
            r.return = e,
            r)
        }
        function c(e, t, n, r) {
            return null === t || t.tag !== Io ? ((n = Po(n, e.internalContextTag, r)).return = e,
            n) : ((t = a(t, r)).pendingProps = n,
            t.return = e,
            t)
        }
        function p(e, t, n, r) {
            return null === t || t.tag !== Lo ? ((t = To(n, e.internalContextTag, r)).type = n.value,
            t.return = e,
            t) : ((t = a(t, r)).type = n.value,
            t.return = e,
            t)
        }
        function f(e, t, n, r) {
            return null === t || t.tag !== Oo || t.stateNode.containerInfo !== n.containerInfo || t.stateNode.implementation !== n.implementation ? ((n = So(n, e.internalContextTag, r)).return = e,
            n) : ((t = a(t, r)).pendingProps = n.children || [],
            t.return = e,
            t)
        }
        function h(e, t, n, r) {
            return null === t || t.tag !== Do ? ((n = Eo(n, e.internalContextTag, r)).return = e,
            n) : ((t = a(t, r)).pendingProps = n,
            t.return = e,
            t)
        }
        function g(e, t, n) {
            if ("string" == typeof t || "number" == typeof t)
                return (t = xo("" + t, e.internalContextTag, n)).return = e,
                t;
            if ("object" == typeof t && null !== t) {
                switch (t.$$typeof) {
                case Ho:
                    return (n = Co(t, e.internalContextTag, n)).ref = Vo(null, t),
                    n.return = e,
                    n;
                case vo:
                    return (t = Po(t, e.internalContextTag, n)).return = e,
                    t;
                case bo:
                    return (n = To(t, e.internalContextTag, n)).type = t.value,
                    n.return = e,
                    n;
                case ko:
                    return (t = So(t, e.internalContextTag, n)).return = e,
                    t
                }
                if (_o(t) || Bo(t))
                    return (t = Eo(t, e.internalContextTag, n)).return = e,
                    t;
                Wo(e, t)
            }
            return null
        ...
        function v(e, a, l, u) {
            ...
            if (null === p) {
                for (; f < l.length; f++)
                    (p = g(e, l[f], u)) && (a = i(p, a, f),
                    null === c ? s = p : c.sibling = p,
                    c = p);
                return s
            }
            for (p = o(e, p); f < l.length; f++)
                (d = y(p, e, f, l[f], u)) && (t && null !== d.alternate && p.delete(null === d.key ? f : d.key),
                a = i(d, a, f),
        ...
        function b(e, a, l, u) {
            ...
            for (var c = s = null, p = a, f = a = 0, h = null, v = l.next(); null !== p && !v.done; f++,
            v = l.next()) {
                p.index > f ? (h = p,
                p = null) : h = p.sibling;
            ...
            if (null === p) {
                for (; !v.done; f++,
                v = l.next())
                    null !== (v = g(e, v.value, u)) && (a = i(v, a, f),
                    null === c ? s = v : c.sibling = v,
                    c = v);
                return s
            }
            for (p = o(e, p); !v.done; f++,
            v = l.next())
                null !== (v = y(p, e, f, v.value, u)) && (t && null !== v.alternate && p.delete(null === v.key ? f : v.key),
                a = i(v, a, f),
                null === c ? s = v : c.sibling = v,
                c = v);
            return t && p.forEach(function(t) {
        ...
        cloneChildFibers: function(e, t) {
            ...
            null !== t.child) {
                ...
                n.return = t; null !== e.sibling; )
                    e = e.sibling,
                    (n = n.sibling = wo(e, e.pendingWorkPriority)).pendingProps = e.pendingProps,
                    n.return = t;
                n.sibling = null
            }
        }
    ...
    function La(e, t, n, r, o) {
        ...
        function p(e) {
            var t = e.stateNode;
            t.pendingContext ? da(e, t.pendingContext, t.pendingContext !== t.context) : t.context && da(e, t.context, !1),
            b(e, t.containerInfo)
        }
        function f(e, t) {
            return la(e, t),
          ...
          , E = (e = function(e, t, n, r) {
            ...
            return {
                ...
                mountClassInstance: function(e, t) {
                    ...
                    "function" == typeof r.componentWillMount && (l = r.state,
                    r.componentWillMount(),
                    l !== r.state && a.enqueueReplaceState(r, r.state, null),
                    null !== (l = e.updateQueue) && (r.state = ta(n, e, l, r, o, i, t))),
                ...
                updateClassInstance: function(e, t, o) {
                    ...
                    var c = i.context
                      , p = Qo(t);
                    if (p = Go(t, p),
                    "function" != typeof i.componentWillReceiveProps || l === u && c === p || (c = i.state,
                    i.componentWillReceiveProps(u, p),
                    i.state !== c && a.enqueueReplaceState(i, i.state, null)),
                    c = t.memoizedState,
                    o = null !== t.updateQueue ? ta(e, t, t.updateQueue, i, c, u, o) : c,
                    !(l !== u || c !== o || na() || null !== t.updateQueue && t.updateQueue.hasForceUpdate))
                        return "function" != typeof i.componentDidUpdate || l === e.memoizedProps && c === e.memoizedState || (t.effectTag |= Ko),
                        !1;
                    var f = u;
                    ...
                    return f ? ("function" == typeof i.componentWillUpdate && i.componentWillUpdate(u, o, p),
                    "function" == typeof i.componentDidUpdate && (t.effectTag |= Ko)) : ("function" != typeof i.componentDidUpdate || l === e.memoizedProps && c === e.memoizedState || (t.effectTag |= Ko),
                    n(t, u),
                    r(t, o)),
                    i.props = u,
                    i.state = o,
        ...
        return {
            beginWork: function(e, t, n) {
                ...
                case ga:
                    ...
                    var r = t.type
                      , o = t.pendingProps
                      , i = ca(t);
                    return r = r(o, i = sa(t, i)),
                    t.effectTag |= _a,
                    "object" == typeof r && null !== r && "function" == typeof r.render ? (t.tag = ya,
                    o = fa(t),
                    E(t, r),
                    P(t, n),
                    t = c(e, t, !0, o)) : (t.tag = ma,
                    a(e, t, r),
                    t.memoizedProps = o,
                    t = t.child),
                    t;
                ...
                case va:
                    return p(t),
                    null !== (r = t.updateQueue) ? (o = t.memoizedState) === (r = ua(e, t, r, null, o, null, n)) ? (w(),
                    t = f(e, t)) : (o = r.element,
                    null !== e && null !== e.child || !k(t) ? (w(),
                    a(e, t, o)) : (t.effectTag |= Na,
                ...
                case ba:
                    ...
                    return null === (r = t.pendingProps) && (null === (r = u) && d("154")),
                    i = null !== e ? e.memoizedProps : null,
                    pa() || null !== r && u !== r ? (u = r.children,
                    g(o, r) ? u = null : i && g(o, i) && (t.effectTag |= Aa),
                    l(e, t),
                    n !== Sa && !m && y(o, r) ? (t.pendingWorkPriority = Sa,
                    t = null) : (a(e, t, u),
                    t.memoizedProps = r,
                    t = t.child)) : t = f(e, t),
                    t;
                ...
                case Ca:
                    ...
                    pa() ? null === n && (null === (n = e && e.memoizedProps) && d("154")) : null !== n && t.memoizedProps !== n || (n = t.memoizedProps),
                    o = n.children,
                    r = t.pendingWorkPriority,
                    t.stateNode = null === e ? oa(t, t.stateNode, o, r) : e.child === t.child ? aa(t, t.stateNode, o, r) : ia(t, t.stateNode, o, r),
                    t.memoizedProps = n,
                    t.stateNode;
                case xa:
                    return null;
                case wa:
                    e: {
                        if (b(t, t.stateNode.containerInfo),
            ...
            beginFailedWork: function(e, t, n) {
                ...
                t.pendingWorkPriority === Ta || t.pendingWorkPriority > n ? h(0, t) : (t.firstEffect = null,
                t.lastEffect = null,
                i(e, t, null, n),
                t.tag === ya && (e = t.stateNode,
    ...
    function Ji(e) {
        function t() {
            ...
            for (var t = null, n = Fi; null !== e; )
                e.current.pendingWorkPriority !== Fi && (n === Fi || n > e.current.pendingWorkPriority) && (n = e.current.pendingWorkPriority,
                t = e),
        ...
        function n(n) {
            ...
            W = o; null !== W; ) {
                ...
                try {
                    for (; null !== W; ) {
                        var l = W.effectTag;
                        if (l & Wi && e.resetTextContent(W.stateNode),
                        l & Ki) {
                            var u = W.alternate;
                            null !== u && F(u)
                        }
        ...
        function r(e) {
            for (; ; ) {
                ...
                e.effectTag > Ui && (null !== n.lastEffect ? n.lastEffect.nextEffect = e : n.firstEffect = e,
                n.lastEffect = e)),
                null !== r)
                    return r;
                if (null === n) {
        ...
        function l() {
            if (null !== Y && 0 < Y.size && V === Ii)
                for (; null !== B; ) {
                    var e = B;
                    if (null === (B = null !== Y && (Y.has(e) || null !== e.alternate && Y.has(e.alternate)) ? a(B) : o(B)) && (null === z && d("179"),
                    R = Ii,
                    n(z),
                    R = V,
        ...
        function u(e, r) {
            ...
            !(V === Fi || V > e)) {
                ...
                e: for (; ; ) {
                    if (V <= Ii)
                        for (; null !== B && !(null === (B = o(B)) && (null === z && d("179"),
                        R = Ii,
                        n(z),
                        R = V,
                        l(),
        ...
        function c(e, t) {
            ...
            if (e.tag === qi)
                ...
                for (var i = e.return; null !== i && null === n; ) {
                    if (i.tag === Qi ? "function" == typeof i.stateNode.componentDidCatch && (r = !0,
                    a = le(i),
                    n = i,
                    o = !0) : i.tag === qi && (n = i),
                    p(i)) {
                        if (ee || null !== Q && (Q.has(i) || null !== i.alternate && Q.has(i.alternate)))
                            return null;
                        n = null,
                        o = !1
                    }
        ...
        function h(e, t) {
            ...
            for (var n = !0; null !== e && n; ) {
                if (n = !1,
                (e.pendingWorkPriority === Fi || e.pendingWorkPriority > t) && (n = !0,
                e.pendingWorkPriority = t),
                null !== e.alternate && (e.alternate.pendingWorkPriority === Fi || e.alternate.pendingWorkPriority > t) && (n = !0,
                e.alternate.pendingWorkPriority = t),
                null === e.return) {
                    if (e.tag !== qi)
                        break;
                    var r = e.stateNode;
                    if (t === Fi || r.isScheduled || (r.isScheduled = !0,
        ...
        function g(e, t) {
            var n = R;
            return n === Fi && (n = !I || e.internalContextTag & Mi || t ? Di : Oi),
            n === Oi && (M || j) ? Ii : n
        }
        function m(e) {
            h(e, Ii)
        ...
        var y = function(e) {
          ...
          , v = function(e) {
            ...
            return {
                enterHydrationState: function(e) {
                    return g = u(e.stateNode.containerInfo),
                    h = e,
                    m = !0
                },
                resetHydrationState: function() {
          ...
          , P = function(e, t, n) {
            ...
            return {
                completeWork: function(e, t, n) {
                    ...
                    switch (null === m ? m = t.memoizedProps : t.pendingWorkPriority === Xa && n !== Xa || (t.pendingProps = null),
                    t.tag) {
                    case ja:
                        return null;
                    case Ha:
                    ...
                    case Ba:
                        return p(t),
                        Ma(t),
                        (m = t.stateNode).pendingContext && (m.context = m.pendingContext,
                    ...
                    case Wa:
                        if (e && null != t.stateNode)
                            ...
                            e = u(),
                            n = c(),
                            g(t) ? h(t) && (t.effectTag |= Za) : t.stateNode = o(m, e, n, t)
                        }
                        return null;
                    case $a:
                        ...
                        return m = (y = m.handler)(m.props, n),
                        t.child = Da(t, null !== e ? e.child : null, m, t.pendingWorkPriority),
                        t.child;
                    case Ka:
                        return t.tag = $a,
                        null;
          ...
          , T = (y = function(e, t) {
            ...
            function a(e) {
                for (var t = e, n = !1, r = void 0, a = void 0; ; ) {
                    ...
                    if (t.tag === ai || t.tag === ii)
                        o(t),
                        a ? y(r, t.stateNode) : m(r, t.stateNode);
                    else if (t.tag === li ? r = t.stateNode.containerInfo : i(t),
                    null !== t.child) {
                        t.child.return = t,
                        t = t.child;
                        continue
            ...
            function i(e) {
                switch ("function" == typeof ci && ci(e),
                e.tag) {
                case ri:
                    n(e);
                    var r = e.stateNode;
            ...
            return {
                commitPlacement: function(e) {
                    ...
                    for (var a = e; ; ) {
                        if (a.tag === ai || a.tag === ii)
                            n ? o ? g(t, a.stateNode, n) : h(t, a.stateNode, n) : o ? f(t, a.stateNode) : p(t, a.stateNode);
                ...
                commitLifeCycles: function(e, t) {
                    ...
                    case ai:
                        n = t.stateNode,
                        null === e && t.effectTag & fi && l(n, t.type, t.memoizedProps, t);
                        break;
                    case ii:
                    case li:
                        break;
    ...
    var fl = null;
    function dl() {
        return !fl && o.canUseDOM && (fl = "textContent"in document.documentElement ? "textContent" : "innerText"),
        fl
    }
    var hl = function(e) {
        ...
        i = (e = l.startContainer === l.endContainer && l.startOffset === l.endOffset ? 0 : l.toString().length) + t,
      ...
      , gl = function(e, t) {
        if (window.getSelection) {
            ...
            r && e) {
                ...
                n.removeAllRanges(),
                o > t ? (n.addRange(a),
                n.extend(e.node, e.offset)) : (a.setEnd(e.node, e.offset),
                n.addRange(a))
            }
        }
    }
      ...
      , yl = {
        ...
        restoreSelection: function(e) {
            ...
            t !== n && c(document.documentElement, n)) {
                for (yl.hasSelectionCapabilities(n) && yl.setSelection(n, e),
                t = [],
                e = n; e = e.parentNode; )
                    e.nodeType === ml && t.push({
                        element: e,
                        left: e.scrollLeft,
                        top: e.scrollTop
                    });
        ...
        setSelection: function(e, t) {
            ...
            e.selectionEnd = Math.min(r, e.value.length)) : gl(e, t)
        }
    }
      , vl = yl
      , bl = H;
    ...
    function Cl(e) {
        ...
        var t = ae.get(e);
        if (t)
            return "number" == typeof t.tag ? kl(t) : wl(t);
    ...
    function Pl(e, t) {
        for (var n = 0, r = e; r; r = xl(r))
            n++;
        r = 0;
        for (var o = t; o; o = xl(o))
            r++;
        for (; 0 < n - r; )
            e = xl(e),
            n--;
    ...
    var Tl = {
      ...
      , Sl = st.getListener;
    function _l(e, t, n) {
        (t = Sl(e, n.dispatchConfig.phasedRegistrationNames[t])) && (n._dispatchListeners = tt(n._dispatchListeners, t),
    ...
    function Fl(e, t, n) {
        e && n && n.dispatchConfig.registrationName && (t = Sl(e, n.dispatchConfig.registrationName)) && (n._dispatchListeners = tt(n._dispatchListeners, t),
        n._dispatchInstances = tt(n._dispatchInstances, e))
    }
    function Ol(e) {
      ...
      , Dl = {
        ...
        getData: function() {
            ...
            for (t = 1; t <= i && n[r - t] === o[a - t]; t++)
                ;
            return Ll._fallbackText = o.slice(e, 1 < t ? 1 - t : void 0),
            Ll._fallbackText
        },
        getText: function() {
    ...
    function jl(e, t, n, r) {
        ...
        return this.isDefaultPrevented = (null != n.defaultPrevented ? n.defaultPrevented : !1 === n.returnValue) ? l.thatReturnsTrue : l.thatReturnsFalse,
    ...
    if (o.canUseDOM && "documentMode"in document && (Yl = document.documentMode),
    ...
    var ou = {
        ...
        extractEvents: function(e, t, n, r) {
            ...
            if (ql)
                ...
                ru ? tu(e, n) && (a = Jl.compositionEnd) : "topKeyDown" === e && 229 === n.keyCode && (a = Jl.compositionStart);
            return a ? (Zl && (ru || a !== Jl.compositionStart ? a === Jl.compositionEnd && ru && (o = Rl.getData()) : ru = Rl.initialize(r)),
            ...
            (e = Ql ? function(e, t) {
                ...
                if (ru)
                    return "topCompositionEnd" === e || !ql && tu(e, t) ? (e = Rl.getData(),
                    Rl.reset(),
                    ru = !1,
                    e) : null;
                switch (e) {
            ...
            }(e, n)) ? ((t = zl.getPooled(Jl.beforeInput, t, n, r)).data = e,
            Il.accumulateTwoPhaseDispatches(t)) : t = null,
            [o, t]
        }
    }
      , au = {
    ...
    function uu(e, t, n) {
        return (e = jl.getPooled(lu.change, e, t, n)).type = "change",
    ...
    var hu = !1;
    function gu() {
        su && (su.detachEvent("onpropertychange", mu),
        cu = su = null)
    }
    function mu(e) {
        "value" === e.propertyName && fu(cu) && (e = uu(cu, e, Ge(e)),
        qe.batchedUpdates(pu, e))
    }
    function yu(e, t, n) {
        "topFocus" === e ? (gu(),
        cu = n,
        (su = t).attachEvent("onpropertychange", mu)) : "topBlur" === e && gu()
    }
    function vu(e) {
    ...
    var wu = {
        ...
        extractEvents: function(e, t, n, r) {
            ...
            if ("select" === a || "input" === a && "file" === o.type)
                ...
                !(a = o.nodeName) || "input" !== a.toLowerCase() || "checkbox" !== o.type && "radio" !== o.type || (i = bu);
            if (i && (i = i(e, t)))
                return uu(i, n, r);
            l && l(e, o, t),
    ...
    var Su = {
      ...
      , _u = {
        ...
        extractEvents: function(e, t, n, r) {
            ...
            t = (t = n.relatedTarget || n.toElement) ? oe.getClosestInstanceFromNode(t) : null) : e = null,
            e === t)
                return null;
    ...
    var Uu = {
        ...
        extractEvents: function(e, t, n, r) {
            ...
            if (!o || !Ru("onSelect", o))
                return null;
            switch (o = t ? oe.getNodeFromInstance(t) : window,
            e) {
            case "topFocus":
                (iu(o) || "true" === o.contentEditable) && (Ou = o,
                Iu = t,
                Lu = null);
                break;
            case "topBlur":
    ...
    st.injection.injectEventPluginOrder("ResponderEventPlugin SimpleEventPlugin TapEventPlugin EnterLeaveEventPlugin ChangeEventPlugin SelectEventPlugin BeforeInputEventPlugin".split(" ")),
    ...
    var Ds = function(e) {
        ...
        return {
            ...
            updateContainer: function(e, t, o, a) {
                ...
                t = a,
                a = r(i, On.enableAsyncSubtreeAPI && null != e && null != e.type && null != e.type.prototype && !0 === e.type.prototype.unstable_isAsyncReactComponent),
                nl(i, e = {
                    element: e
                }, void 0 === t ? null : t, a),
                n(i, a)
    ...
    var Us = {
        ...
        unstable_renderSubtreeIntoContainer: function(e, t, n, r) {
            return null != e && ae.has(e) || d("38"),
            Rs(e, t, n, !1, r)
        },
        unmountComponentAtNode: function(e) {
            return Ls(e) || d("40"),
            !!e._reactRootContainer && (Ds.unbatchedUpdates(function() {
...
, function(e, t, n) {
    ...
    var S, _ = function(e) {
        function t() {
            ...
            for (var r = arguments.length, o = new Array(r), a = 0; a < r; a++)
                o[a] = arguments[a];
            return (n = y()(this, (e = b()(t)).call.apply(e, [this].concat(o)))).start = [0, 0],
            n.end = [0, 0],
            n.endTime = 0,
            n.saveRef = function(e) {
                return n.dom = e
        ...
        function t() {
            ...
            for (var r = arguments.length, o = new Array(r), a = 0; a < r; a++)
                o[a] = arguments[a];
            return (n = y()(this, (e = b()(t)).call.apply(e, [this].concat(o)))).queue = [],
            n.container = null,
            n
        }
        return w()(t, e),
        g()(t, [{
            ...
            value: function() {
                this.container && (i.a.unmountComponentAtNode(this.container),
        ...
        function t() {
            ...
            for (var r = arguments.length, o = new Array(r), a = 0; a < r; a++)
                o[a] = arguments[a];
            return (n = y()(this, (e = b()(t)).call.apply(e, [this].concat(o)))).fullStyle = ["/*\n* I don't know what to make for you for Valentine's, but I thought this would be cool, heh.\n* Thank you for being there for me when no one was.\n* I just want to say that you’re amazing, and I’m really sorry for what you’re going through. \n* You don’t deserve any of it, and I hope things get better soon. \n* No matter what, I’m here for you. \n* I also know I’ve been acting different lately, and I’m really sorry for that. \n* Just wanted to let you know I appreciate you.".concat(A ? "Enjoy this short coding I made for you. Hope this cheer you up a bit." : "", "\n*/\n\n/* First, add transition effects to all elements */\n* {\n  -webkit-transition: all .5s;\n  transition: all .5s;\n}\n/* The white background is too boring. Let's have some background */\nbody, html {\n  color: #fff;\n  background-color: HotPink;\n}\n\n/* The texts are too close let's fix that */\n.styleEditor {\n  overflow: auto;\n  ").concat(A ? "width: 48vw;\n  height: 96vh;" : "width: 96vw;\n  height: 48vh;", "\n  border: 1px solid;\n  font-size: 14px;\n  line-height: 1.5;\n  padding: 10px;\n}\n\n/* These codes are all the same color. Let's add some highlights to distinguish them. */\n.token.selector{ color: rgb(133,153,0) }\n.token.property{ color: rgb(187,137,0) }\n.token.punctuation{ color: yellow }\n.token.function{ color: rgb(42,161,152) }\n.token.comment{ color: rgb(177,177,177) }\n\n/* Let's add a 3D effect */\nhtml{\n  perspective: 1000px;\n  -webkit-perspective: 1000px;\n}\n\n.styleEditor {\n  ").concat(A ? "transform: rotateY(10deg) translateZ(-100px) ;\n  -webkit-transform: rotateY(10deg) translateZ(-100px);" : "transform: rotateX(-10deg) translateZ(-100px);\n  -webkit-transform: rotateX(-10deg) translateZ(-100px);", " ").concat(A ? "" : "\n  transform-origin: 50% 0% 0;\n  -webkit-transform-origin: 50% 0% 0;", "\n}\n\n/*\n* I will be making a cool heart with a surprise at the end. \n* 😏 \n*/\n\n/* First, add a white backround */\n.heartWrapper {\n  ").concat(A ? "width: 48vw;\n  height: 96vh;" : "width: 96vw;\n  height: 48vh;", "\n  position: relative;\n  border: 1px solid;\n  background-color: white;\n  ").concat(A ? "transform: rotateY(-10deg) translateZ(-100px);\n  -webkit-transform: rotateY(-10deg) translateZ(-100px);" : "transform: rotateX(10deg) translateZ(-100px);\n  -webkit-transform: rotateX(10deg) translateZ(-100px);").concat(A ? "" : "\n  transform-origin: 50% 0% 0;\n  -webkit-transform-origin: 50% 0% 0;", "\n}\n\n/* Make a square slightly tilted */\n.heart {\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  margin: -50px 0 0 -50px;\n  border-radius: 20px;\n  background: #E88D8D;\n  transform: rotate(45deg);\n}\n\n/* Make the left side of the heart */\n.heart::before {\n  content: '';\n  background: #E88D8D;\n  border-radius: 50%;\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  left: -38px;\n  top: 1px;\n}\n\n/* Make the right side of the heart */\n.heart::after {\n  content: '';\n  background: #E88D8D;\n  border-radius: 50%;\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  right: -1px;\n  top: -38px;\n}\n\n/* It's too bland, lets make the heart beat  */\n@keyframes throb {\n  0% {\n    transform: scale(1) rotate(45deg);\n    opacity: 1;\n  }\n\n  100% {\n    transform: scale(1.65) rotate(45deg);\n    opacity: 0\n  }\n}\n\n.bounce {\n  opacity: 0.2;\n  animation: throb 1s infinite linear;\n}\n/*\n* Ok，Done！\n* Happy Valentine's Day!！\n*/\n\n")],
            n.state = {
                currentStyleCode: "",
                finished: !1,
                heartRains: []
                ...
                var e = p()(s.a.mark(function e() {
                    ...
                    return s.a.wrap(function(e) {
                        for (; ; )
                            ...
                            case 0:
                                return t = i.length > 0 && void 0 !== i[0] ? i[0] : 0,
                                n = this.interval,
                                r = this.fullStyle,
                                o = function e(o) {
                                    return new Promise(function(i) {
                                        ...
                                        if (l && u) {
                                            ...
                                            "\n" === u && a.styleEditor && a.styleEditor.toBottom(),
                                            setTimeout(function() {
                                                i(e(o + 1))
                                            }, n)
                                        } else
    ...
    n(31);
    S = F,
    i.a.render(o.a.createElement(l.AppContainer, null, o.a.createElement(S, null)), document.getElementById("app"))
}
]);
